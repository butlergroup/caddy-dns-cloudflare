...
- Updated alpine from `28bd5fe` to `294b683` through automated dependency management
...
- Updated caddy from `fc72c8a` to `1a1689d` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.53 (09-03-2026)
...
## caddy-dns-cloudflare Version v0.2.52 (09-02-2026)
...
## caddy-dns-cloudflare Version v0.2.51 (09-02-2026)

#### New Features

#### Improvements

- Updated caddy from `7bac9be` to `fc72c8a` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.50 (09-01-2026)
...
- Updated github.com/quic-go/quic-go from v0.61.0 to v0.62.0 through automated dependency management
- chore: Update go.mod dependencies
...
## caddy-dns-cloudflare Version v0.2.47 (08-28-2026)
...
## caddy-dns-cloudflare Version v0.2.46 (08-24-2026)

#### New Features

#### Improvements

- Updated caddy from `c2433c7` to `7bac9be` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.43 (08-17-2026)

#### New Features

#### Improvements

- Updated caddy from `8e89605` to `c2433c7` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.42 (08-14-2026)
...
## caddy-dns-cloudflare Version v0.2.39 (08-12-2026)
...
## caddy-dns-cloudflare Version v0.2.36 (07-23-2026)
...
## caddy-dns-cloudflare Version v0.2.33 (07-11-2026)
...
## caddy-dns-cloudflare Version v0.2.32 (07-09-2026)
...
## caddy-dns-cloudflare Version v0.2.31 (07-09-2026)
...
## caddy-dns-cloudflare Version v0.2.30 (07-08-2026)
...
## caddy-dns-cloudflare Version v0.2.29 (07-08-2026)

#### New Features

#### Improvements

- Updated caddy from `b6a94e7` to `fd20748` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.28 (07-07-2026)
...
## caddy-dns-cloudflare Version v0.2.25 (06-26-2026)
...
## caddy-dns-cloudflare Version v0.2.24 (06-25-2026)

#### New Features

#### Improvements

- Updated caddy from `8e8c654` to `b6a94e7` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.23 (06-23-2026)

#### New Features

#### Improvements

- Updated caddy from `0ff10d4` to `8e8c654` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.18 (06-11-2026)
...
## caddy-dns-cloudflare Version v0.2.17 (06-10-2026)

#### New Features

#### Improvements

- Updated alpine from `5b10f43` to `a2d49ea` through automated dependency management
- updated-dependencies:
...
## caddy-dns-cloudflare Version v0.2.16 (06-09-2026)
